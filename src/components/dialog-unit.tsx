...
import { useCreateUnit } from '@/hooks/useMutation/useCreateUnit'
import { useUpdateUnit } from '@/hooks/useMutation/useUpdateUnit'
...
export default function DialogUnit({
	setName,
	name,
	forEdit = false,
	onOpenChange,
	...
	function handleSubmit(e: React.FormEvent) {
		...
		if (id && id.trim()) {
			updateUnitMutation.mutate({ id, name })
